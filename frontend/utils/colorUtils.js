...
export const getAIAvatarStyles = (aiName) => {
  ...
  if (formattedName === 'badgirl') {
    return AI_COLORS.BadGirl;
  }
...
export const generateColorFromEmail = (email) => {
  ...
  if (email.endsWith('@BadGirl.ai')) {
    globalColorCache.set(email, AI_COLORS.BadGirl.backgroundColor);
    return AI_COLORS.BadGirl.backgroundColor;
  }
